package com.dolphine.authentication.utils;
...
public class AuthenticationConstants {
    ...
    public static String buildOtpValidationBody(String recipientName, String otp) {
        return AuthenticationConstants.WISH + recipientName + AuthenticationConstants.COMMA +
        		AuthenticationConstants.NEW_LINE + AuthenticationConstants.BODY_BEFORE_OTP + otp +
        		AuthenticationConstants.NEW_LINE + AuthenticationConstants.BODY_AFTER_OTP + AuthenticationConstants.SIGNATURE;
    }
